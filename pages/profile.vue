    ...
    <main class="main">
      ...
      <div class="content">
        <template v-if="chosenTabIndex == 0">
          ...
          <div class="tab">
            <div class="tab__text">Add multiple wallets to verify token ownership. All of these wallets can also access your profile.</div>
            <div class="tab__item">
              <div class="wallet">
                <div class="wallet__type">Ethereum Wallets</div>
